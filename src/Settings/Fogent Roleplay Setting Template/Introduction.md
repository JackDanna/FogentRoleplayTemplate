...
This template serves as a blank canvas to build your own world using Fogent Roleplay. Included

Fogent Roleplay are the standard rules for which the Fogent Roleplay App was built.
